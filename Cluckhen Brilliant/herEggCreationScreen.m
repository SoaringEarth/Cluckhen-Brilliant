...
// the female images that will be selectable from the menu system.
//
...
/*
 ...
 2. Un-comment '#import <Social/Social.h> in herEggCreationScreen.h'.
...
- (void)viewDidLoad {
    ...
    // Add subviews to the screen to show the instructions and the 
    ...
    // Default switch case statement to start the menu system at a particular option.
...
- (void)createImages {
    ...
    closeBarBlur = [UIImage imageNamed:@"StartAgainBlur.png"];
...
- (IBAction)openMenu:(id)sender {
    // switch case to open the correct menu when used.
    switch (count)
    {
        case 1:
...
- (void)layoutEyesScrollImages {
    ...
    if (!eyesItemsVisible) {
        for (int i = 1; i <= NumImages; i++) {
            //for each image get the imagename, create a new image using imagename, then create a new imageView using the created image.
            imageEyesName = [NSString stringWithFormat:@"FMenuEyes%d.png", i];
        ...
        [eyesScrollMenu setContentSize:CGSizeMake([eyesScrollMenu bounds].size.width, (NumImages * imageHeight + (NumImages * imageHeight) - 290))];
    }
}
...
- (void)layoutMouthScrollImages {
    ...
    if (!mouthItemsVisible) {
        for (int i = 1; i <= NumImages; i++) {
            //for each image get the imagename, create a new image using imagename, then create a new imageView using the created image.
            imageMouthName = [NSString stringWithFormat:@"FMenuMouth%d.png", i];
        ...
        [mouthScrollMenu setContentSize:CGSizeMake([mouthScrollMenu bounds].size.width, (NumImages * imageHeight + (NumImages * imageHeight) - 290))];
    }
}
...
- (void)layoutHairScrollImages {
    ...
    if (!hairItemsVisible) {
        for (int i = 1; i <= NumImages; i++) {
            //for each image get the imagename, create a new image using imagename, then create a new imageView using the created image.
            imageHairName = [NSString stringWithFormat:@"FMenuHair%d.png", i];
        ...
        [hairScrollMenu setContentSize:CGSizeMake([hairScrollMenu bounds].size.width, (NumImages * imageHeight + (NumImages * imageHeight) - 290))];
    }
}
...
- (void)layoutFeetScrollImages {
    ...
    if (!feetItemsVisible) {
        for (int i = 1; i <= NumImages; i++) {
            //for each image get the imagename, create a new image using imagename, then create a new imageView using the created image.
            imageFeetName = [NSString stringWithFormat:@"FMenuFeet%d.png", i];
        ...
        [feetScrollMenu setContentSize:CGSizeMake([feetScrollMenu bounds].size.width, (NumImages * imageHeight + (NumImages * imageHeight) - 290))];
    }
}
...
- (void)ClickEventEyeImage:(id)Sender {
    ...
    int imageNum = (((UIGestureRecognizer *)Sender).view).tag;
    playerEyesImageName = [NSString stringWithFormat:@"FMainEyes%d.png", imageNum];
...
- (void)ClickEventMouthImage:(id)Sender {
    ...
    int imageNum = (((UIGestureRecognizer *)Sender).view).tag;
    playerMouthImageName = [NSString stringWithFormat:@"FMainMouth%d.png", imageNum];
...
- (void)ClickEventHairImage:(id)Sender {
    ...
    int imageNum = (((UIGestureRecognizer *)Sender).view).tag;
    playerHairImageName = [NSString stringWithFormat:@"FMainHair%d.png", imageNum];
...
- (void)ClickEventFeetImage:(id)Sender {
    ...
    int imageNum = (((UIGestureRecognizer *)Sender).view).tag;
    playerFeetImageName = [NSString stringWithFormat:@"FMainFeet%d.png", imageNum];
